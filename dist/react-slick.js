	...
	var InnerSlider = exports.InnerSlider = _react2.default.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    if (this.props.lazyLoad) {
	      this.setState({
	        lazyLoadedList: this.getLazyLoadList(this.state.currentSlide)
	      });
	    }
	  },
	  componentDidMount: function componentDidMount() {
	...
	var helpers = {
	  ...
	  slideHandler: function slideHandler(index) {
	    ...
	    if (this.props.fade) {
	      ...
	      var updatedLazyLoadedList = this.props.lazyLoad ? this.updateLazyLoadList(index) : this.state.lazyLoadedList;
	  ...
	  setLazyLoadList: function setLazyLoadList(index) {
